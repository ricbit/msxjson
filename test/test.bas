...
280 PRINT "TESTING CAN'T CALL USR2(NOTHING)":EX=5:A=USR2("&NOTHING"):GOSUB8000
290 PRINT "TESTING CAN'T CALL USR2(OBJECT)":EX=5:A=USR2("#1"):GOSUB8000
300 PRINT "TESTING CAN'T CALL USR2(ARRAY)":EX=5:A=USR2(""):GOSUB8000
310 PRINT "TESTING CAN'T USE # ON STRING":EX=5:A=USR1("#0#0"):GOSUB8000
320 PRINT "TESTING CAN'T USE # ON NUMBER":EX=5:A=USR1("#2#0"):GOSUB8000
330 PRINT "TESTING CAN'T USE # ON TRUE":EX=5:A=USR1("#3#0"):GOSUB8000
340 PRINT "TESTING CAN'T USE # ON FALSE":EX=5:A=USR1("#4#0"):GOSUB8000
350 PRINT "TESTING CAN'T USE # ON NULL":EX=5:A=USR1("#5#0"):GOSUB8000
360 A$="ERROR1.TXT":GOSUB3000
370 PRINT "TESTING CAN'T CALL USR1 AFTER USR FAILS":EX=5:A=USR1(""):GOSUB8000
380 PRINT "TESTING CAN'T CALL USR2 AFTER USR FAILS":EX=5:A=USR2(""):GOSUB8000
990 END
